                ...
                .forEach((row: any) => {
                    ...
                    if (!existing || doh > 0) {
                        partMap.set(part, {
                            ...
                            // Parsed like day1-6: the backend types these as f64 now,
                            // so a raw string would fail the whole upload
                            day7:     parseFloat(row[24]),
                            day8:     parseFloat(row[25]),
                            day9:     parseFloat(row[26]),
                            day10:    parseFloat(row[27]),
                            day11:    parseFloat(row[28]),
                            day12:    parseFloat(row[29]),
                            day13:    parseFloat(row[30]),
                            day14:    parseFloat(row[31]),
                            day15:    parseFloat(row[32]),
                            day16:    parseFloat(row[33]),
                            day17:    parseFloat(row[34]),
                            day18:    parseFloat(row[35]),
                            day19:    parseFloat(row[36]),
                            day20:    parseFloat(row[37]),
                            day21:    parseFloat(row[38]),
                        })
                    }
                })
